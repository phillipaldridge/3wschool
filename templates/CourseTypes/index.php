 ...
 * @var iterable<\App\Model\Entity\CourseType> $courseTypes
 */
?>
<div class="courseTypes index content">
    <?= $this->Html->link(__('New Course Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
