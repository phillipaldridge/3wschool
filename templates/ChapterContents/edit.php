...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $chapterContent->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $chapterContent->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="chapterContents form content">
            ...
            <fieldset>
                <legend><?= __('Edit Chapter Content') ?></legend>
                <?php
