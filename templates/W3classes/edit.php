 ...
 * @var string[]|\Cake\Collection\CollectionInterface $w3classTypes
...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $w3class->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $w3class->id), 'class' => 'side-nav-item']
            ) ?>
